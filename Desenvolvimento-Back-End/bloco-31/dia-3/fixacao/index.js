...
// linhas referentes a Unmanaged transactions / Managed transactions
...
// rota referente a Unmanaged transactions
...
// rota utilizando Managed transactions
app.post('/employees', async (req, res) => {
  try {
    const { firstName, lastName, age, city, street, number } = req.body;
...
// Requisição incluindo o numbero.
